        ...
        >
            ...
            <div className="flex items-center justify-between pt-2 border-t border-(--border)/50 text-[10px] text-(--muted)" style={{ fontFamily: 'var(--mono)' }}>
                <div className="flex items-center gap-1.5 group-hover:text-(--accent) transition-colors">
                    ...
                    <span className="uppercase tracking-wider">{repoUrl ? 'GitHub Repo' : liveUrl ? 'Live Demo' : 'View Project'} →</span>
                </div>

                <div className="flex items-center gap-1.5">
                    <svg className="text-(--accent)" xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7 17 17 7"/><path d="M7 7h10v10"/></svg>
                </div>
            </div>
        </motion.a>
    );
