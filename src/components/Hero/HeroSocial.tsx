export default function HeroSocial() {
    return (
        <>
            <a href="https://github.com/Doyen04" target="_blank" rel="noopener noreferrer" className="transition-colors p-2" aria-label="GitHub — Ademola" title="GitHub">
            ...
            <a href="https://www.linkedin.com/in/sola-opeyemi-ademola" target="_blank" rel="noopener noreferrer" className="transition-colors p-2" aria-label="LinkedIn — Ademola" title="LinkedIn">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect width="4" height="12" x="2" y="9" /><circle cx="4" cy="4" r="2" /></svg>
            </a>
            <a href="mailto:oluwasolaopeyemi93@gmail.com" className="transition-colors p-2" aria-label="Email — Ademola" title="Email">
