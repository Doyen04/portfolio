...
export default function BrowserMockup() {
    return (
        <motion.div
            ...
            className="w-full relative bg-(--surface-2) border border-(--border) overflow-hidden"
            ...
            <div className="p-4" style={{ height: 'calc(100% - 34px)' }}>
                ...
                <div className="flex-1 flex flex-col gap-4 pt-2 overflow-hidden">
                    ...
                    <div className="border border-(--accent)/30 p-2.5 flex items-center justify-between" style={{ background: 'rgba(200, 145, 58, 0.05)' }}>
                        ...
                        <button data-keep-radius="true" className="px-2.5 py-1 text-[8px] bg-(--accent) text-(--bg) font-mono font-medium tracking-wider uppercase hover:bg-(--accent-hi) transition-colors" style={{ border: 'none', cursor: 'pointer' }}>
                            Cancel Sub
                        </button>
                    </div>
